...
Con la siguiente función se extraen los campos con carga semántica del documento (title, abstract) junto al identificador scopusid y se guardan en un CSV (UTF-8) para su procesamiento en fases posteriores.
...
\begin{enumerate}
    ...
    \item \textbf{Tokenización}. Segmentar cada oración en unidades mínimas (tokens), como palabras o subpalabras, lo que constituye la base de la extracción de rasgos
     y representaciones.
