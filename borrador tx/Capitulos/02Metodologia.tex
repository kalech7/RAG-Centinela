...
\paragraph{Dataset:} El dataset se construye a partir de la base de datos de Scopus, por lo que se tiene un total de
27.754 artículos.
\paragraph{Diseño del experimento} para ejecutar los experiments n palabras clave en areas para que sean validadas por
expertos
