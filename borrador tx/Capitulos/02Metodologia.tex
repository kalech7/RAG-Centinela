...
promedios sobre el conjunto de consultas.
...
\begin{enumerate}[label=\textbf{(\roman*)},leftmargin=*,itemsep=0.35em]
    ...
    Ambas métricas se reportan como promedios macro sobre las consultas.

    \item \textit{Augmentation}: se reporta la \textbf{Ganancia de augmentation}, definida como la mejora en la métrica
    objetivo al inyectar contexto frente al uso del LLM sin recuperación,
