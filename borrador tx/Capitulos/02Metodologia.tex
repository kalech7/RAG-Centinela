...
\begin{enumerate}[label=\textbf{(\roman*)},leftmargin=*,itemsep=0.35em]
    ...
    \begin{enumerate}[label=\textbf{P\arabic*},leftmargin=*,itemsep=0.25em]
        ...
        Se obtiene un índice global de acuerdo por consulta (\(A_i\)), el promedio macro \(\overline{A}\) sobre el
        conjunto de pruebas y el \textbf{coeficiente de acuerdo de Cohen} (\(\kappa\)),
        tras binarizar las valoraciones (\emph{acuerdo} si \(A_i \geq 4\)).
