...
\begin{enumerate}
    ...
    Se incluirán únicamente revisiones sistemáticas y metaanálisis publicados entre 2019 y 2025, en inglés o español, que presenten una evaluación metodológica explícita.  
    ...
    Los hallazgos se organizarán en tres niveles complementarios:  
    \begin{itemize}
...
\end{enumerate}
En esta metodología, el enfoque de \textbf{Umbrella Review} se emplea como marco general para sintetizar evidencia secundaria, integrando hallazgos provenientes exclusivamente de revisiones sistemáticas y metaanálisis. A diferencia de una búsqueda sistemática tradicional, la estrategia se complementa con la \textbf{propagación de citaciones} (\textit{backward} y \textit{forward citation}), lo que permite ampliar 
distintas perspectivas y enfoques temáticos. La combinación de ambos, aporta que la incorporación de aportes sean recientes y complementarios, ofreciendo un panorama más completo y permitiendo observar la evolución del conocimiento disponible.
