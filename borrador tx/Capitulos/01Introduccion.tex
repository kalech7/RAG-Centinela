...
En general no resuleven tareas de gestion datos como esquemas y metadatos, control de concurrencia, replicación , etc. Por lo que son considerados componentes de bajo nivel que se agregan en sistemas mayores.
...
\addlinespace[2pt]
 & FAISS & Librería de Facebook/Meta para búsqueda de vecinos más cercanos con soportes clásicos (IVF, PQ) y aceleración CPU/GPU; ampliamente usada como backend en VDBs. \\
 & ANNOY & Índices basados en árboles para ANN, común en escenarios de baja/mediana dimensionalidad; frecuentemente referenciada junto a FAISS. \\
 & SPTAG & Librería de Microsoft para ANN, mencionada junto a FAISS como “librería”, no como sistema de base de datos completo.\\
\addlinespace[4pt]
...
\addlinespace[2pt]
 ...
 & Weaviate & VDB gestionado con soporte de índices ANN y consultas híbridas; aparece en tablas comparativas de características/distancias. \\
 & Qdrant & VDB orientado a ANN (HNSW), filtrado por metadatos y despliegue gestionado; listado en comparativas de VDBs. \\
\addlinespace[2pt]
VDB (Servicio) & Pinecone & Servicio gestionado de VDB; foco en operación/escala y latencia, citado en comparativas de mercado.  \\
Extensión DB relacional & pgvector & Extensión de PostgreSQL para vectores; habilita ANN/NNS dentro de un RDBMS, citada en tablas de funciones/distancias.  \\
Motor de búsqueda & Elasticsearch & Motor con capacidades vectoriales (denso/esparso) en ediciones recientes; citado como comparativo frente a VDBs dedicadas.\\
\bottomrule
\end{tabular}
