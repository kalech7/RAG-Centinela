...
\begin{itemize}
    ...
    \item \textbf{Evaluación en RAG — Knollmeyer et al. (2024)}
    \begin{itemize}
    ...
    \item \textbf{Perspectiva de Métricas Mixtas — Gao et al. (2023)}
    \begin{itemize}
        \item Recuperación: precisión, recall, nDCG, métricas de cobertura del conocimiento.
        \item Generación: coherencia, verificabilidad, reducción de alucinaciones, calidad narrativa.
        \item Evaluación humana: juicios expertos sobre transparencia, confianza y utilidad práctica.
    \end{itemize}
\end{itemize}
