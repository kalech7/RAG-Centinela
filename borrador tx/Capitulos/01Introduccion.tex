...
Como Enhancements, un reranker es el encargado de reordernar el top-k inicial modelnad de forma conjunta (query, fragmento de texto, documento) para estimar directamente la 
relevancia del par y refinar la lista producida por el recuperador.  Esto constituye una segunda etapa
de ranking cuyo fin es elevar la efectividad con modelos de interacción tipo cross-encoder\footnote{Cross-encoder es un modelo de ranking por interacción que recibe consulta y texto juntos} 
tras una primera etapa satisfactoria (sparse o densa)~\textcite{hambarde2023ir}.
