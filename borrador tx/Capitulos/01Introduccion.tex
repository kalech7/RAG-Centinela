...
Más adelante, se detalla el proceso de implementación vease la Figura.~\ref{fig:pipeline-rag}, desde la preparación de los datos hasta el componente de generación, incluyendo las técnicas y herramientas más relevantes.  
