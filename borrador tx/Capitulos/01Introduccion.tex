...
\begin{tikzpicture}[x=1cm,y=1cm]
  ...
  \pill{\y}{softpeach}{IV}{Indexación en Vector DB}
  \pgfmathsetmacro\y{\y+\step}
...
en representaciones numericas para la recuperacion semantica tal como lo expresa \textcite{minaee2021}. Estos vectores se almacenan en una base de datos vectorial que en
conjunto con inidice tradicionales como bm25 permiten la recuperacion hibrida.\parencite{hu2024ragrau}. Con los datos obtenidos, como lo señala \textcite{sarthi2024raptor}, 
