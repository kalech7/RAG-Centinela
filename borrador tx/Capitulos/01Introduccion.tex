...
CEDR & Re-ranker basado en BERT que modela interacciones contexto–término para reordenar los pasajes más relevantes tras una primera recuperación. \\
DuoBERT & Enfoque de aprendizaje a pares: compara (doc\_positivo, doc\_negativo) para aprender un mejor ordenamiento final. \\
DRMM & Deep Relevance Matching Model: usa funciones de coincidencia término–término y una red con “term gating” para estimar relevancia y reordenar. \\
\end{tabularx}
\caption{Técnicas Reranking}
