...
Para ello, esta revisión se apoya en Umbrella SLR y propagación de citaciones usando el protocolo propuesto en la Sección~\ref{sec:revision-sistematica};
...
% --- Augmentation
    \addlinespace[2pt]
    \multicolumn{4}{l}{\textbf{Augmentation}}\\
    \cmidrule(lr){1-4}
    Ganancia de augmentation & Efecto marginal de inyectar contexto frente a usar el LLM sin recuperación. &
