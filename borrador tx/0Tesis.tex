...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{@{}X l@{}}
        ...
        \midrule
        % ---------- SINGLE-HOP (5) ----------
        ¿Qué porcentaje de positividad (RT-qPCR) reportó el estudio masivo en 15 cantones de Manabí entre agosto y septiembre de 2020, y cuántas personas fueron evaluadas? & \emph{single-hop} \\
