...
\begin{tcolorbox}[
    ...
    **Instrucciones:**
    1.  Lee la PREGUNTA y el CONTEXTO proporcionado.
    2.  Lee la RESPUESTA GENERADA.
    3.  Compara la RESPUESTA GENERADA únicamente contra el CONTEXTO.
    4.  Determina si la RESPUESTA GENERADA contiene información que NO esté presente en el CONTEXTO.

    **Formato de Salida:**
    Responde únicamente con "FIEL" si toda la información de la respuesta se
    encuentra en el contexto.
    Responde únicamente con "NO FIEL" si la respuesta contiene información
    adicional, contradictoria o inventada (alucinada).
